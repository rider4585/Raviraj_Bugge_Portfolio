...
export const experience: ExperienceItem[] = [
  {
    ...
    achievements: [
      ...
      "Supporting junior developers, conducting reviews, and improving codebase quality.",
...

  {
    ...
    tech: ["React", "Node.js", "ChromaDB", "GitHub Actions"],
  },

  {
    ...
    tech: ["React", "Tailwind", "Sequelize", "Jest"],
  },
